            ...
            <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="relative py-2 group">
                        <img src={assets.menu} className="h-8 w-8 cursor-pointer" alt="" />
                        <div className="absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-(--bg) border border-gray-600 hidden group-hover:block">
