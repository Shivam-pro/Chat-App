...
const Loginpage = () => {
  ...
  return (
    <form className="grid grid-cols-2 md:grid-cols-[2fr_1fr] h-full p-15 items-center" onSubmit={submitHandler}>
      <div className="flex flex-col items-center justify-center h-full">
        <img src={assets.logo} className="h-40 w-50" alt="" />
        <h1 className="text-4xl">Zap Chat</h1>
      </div>
